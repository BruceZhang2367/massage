...
<body>
	...
	<div id="main-div">
		<div id="menu-list">
			<ul id="menu-ul">
				<li class="explode" key="02_cat_and_goods" name="menu"> 商品管理        
					<ul>
						  ...
						  <li class="menu-item"><a href="<?php echo U('Category/CategoryList');?>" target="main-frame">商品分类</a></li>
						  ...
						  <li class="menu-item"><a href="<?php echo U('Goodstype/goods_type_list');?>" target="main-frame">商品类型</a></li>
            ...
            <li class="menu-item"><a href="<?php echo U('Coupon/couponAdd');?>" target="main-frame">添加优惠券</a></li>
