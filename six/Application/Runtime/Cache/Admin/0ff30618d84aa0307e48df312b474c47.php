...
<div class="main-div">
<form method="post" action="/six/index.php/Admin/Brand/brandSave" name="theForm" enctype="multipart/form-data" onsubmit="return validate()">
<table cellspacing="1" cellpadding="3" width="100%">
  <tbody><tr>
    <td class="label">品牌名称</td>
    <td><input type="text" name="brand_name" maxlength="60" value="<?php echo ($brand["brand_name"]); ?>"><span class="require-field">*</span></td>
  </tr>
  <tr>
    <td class="label">品牌网址</td>
    <td><input type="text" name="site_url" maxlength="60" size="40" value="<?php echo ($brand["site_url"]); ?>"></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>
      <?php if($brand["is_show"] == 1): ?><input type="radio" name="is_show" value="1" checked> 是
