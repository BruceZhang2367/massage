...
<base href="/six/Public/admin/" />
	...
	<!-- 配置文件 -->
	<script type="text/javascript" src="/six/Public/ueditor/ueditor.config.js"></script>
	<!-- 编辑器源码文件 -->
	<script type="text/javascript" src="/six/Public/ueditor/ueditor.all.min.js"></script>
          	...
          	<tbody>
          		<tr>
		            <td>
		            	...
		            	<iframe id="goods_desc___Frame"  width="100%" height="320" frameborder="0" scrolling="no" style="margin: 0px; padding: 0px; border: 0px; background-color: transparent; background-image: none; width: 100%; height: 320px;">
		            		<textarea name="" id="" cols="30" rows="10"></textarea>
		            	</iframe> -->
		            	<textarea name="goods_desc" id="container" cols="30" rows="10">
...
<!--            <td><input type="text" name="goods_number" value="4" size
="20" readonly="readonly" /><br />-->
...
<script type="text/javascript">
	...
	$(document).on("change","[name='goods_type']",function(){
		...
		$.ajax({
			...
			url:"/six/index.php/Admin/Goods/getAttr",
			success:function(res){
				$("#tbody-goodsAttr").html(res);
			}
		})
	})
	//加减属性对应行
	$(document).on("click",".addRow",function(){
		...
		if($(this).html()=="[+]"){
			$(this).html("[-]");
			var addrow=$(this).parent().parent().clone();
			// var addrow=$(this).parents("tr").clone();
			//console.log(addrow)
			$(this).parent().parent().after(addrow);
			//$(this).parents("tr").after(addrow);
			$(this).html("[+]");
		}else{
