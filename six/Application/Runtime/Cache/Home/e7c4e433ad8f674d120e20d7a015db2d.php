...
<div class="i_bg">  
    ...
    <form action="<?php echo U('Order/addOrder');?>" method="post" id="form">
    ...
    <div class="content mar_20">
    	<div class="two_bg">
            ...
            <table border="0" class="car_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
              ...
              <?php if(is_array($cart_data)): foreach($cart_data as $key=>$v): ?><tr>
                <td>
                    <div class="c_s_img"><img src="images/c_1.jpg" width="73" height="73" /></div>
                    <?php echo ($v["goods_name"]); ?>
                </td>
                <td align="center"><?php echo ($v["goods_attr"]); ?></td>
                <td align="center"><?php echo ($v["goods_number"]); ?></td>
                <td align="center" style="color:#ff4e00;">￥<?php echo ($v['goods_number']*$v['goods_price']); ?></td>
                <td align="center">26R</td>
              </tr><?php endforeach; endif; ?>
              <tr>
                <td colspan="5" align="right" style="font-family:'Microsoft YaHei';">
                    商品总价：￥<?php echo ($goods_price); ?> ； 返还积分 56R  
                </td>
              </tr>
            </table>
            ...
            <table border="0" class="peo_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td class="car_th" width="200">收货人</td>
                <td class="car_th" width="370">收货地址</td>
                <td class="car_th" width="150">联系方式</td>
              </tr>
              <?php if(is_array($address_data)): foreach($address_data as $key=>$v): ?><tr>
                <td align="center"><input type="radio" name="address" value="<?php echo ($v["address_id"]); ?>" <?php if($v['flag']==1)echo "checked"; ?> /></td>
                <td align="center" style="font-size:14px;"><b><?php echo ($v["consignee"]); ?></b></td>
                <td><?php echo ($v["new_address"]); ?></td>
            ...
            <table border="0" class="car_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
              ...
              <tr>
              	<td align="center"><input type="radio" name="postType" checked="checked" value="1" /></td>
              ...
              <tr>
              	<td align="center"><input type="radio" name="postType" value="2" /></td>
              ...
              <tr>
              	<td align="center"><input type="radio" name="postType" value="3" /></td>
            ...
            <ul class="pay">
                <li class="checked" value="1">余额支付<div class="ch_img"></div></li>
                <li value="2">银行亏款/转账<div class="ch_img"></div></li>
                <li value="3">货到付款<div class="ch_img"></div></li>
                <li value="4">支付宝<div class="ch_img"></div></li>
            </ul>           
            <div class="two_t">
            	其他信息
            </div>
              ...
              <tr>
                ...
                <td>
                    ...
                    <select class="jj" name="coupon_id">
                      ...
                      <?php if(is_array($coupon_data)): foreach($coupon_data as $key=>$v): ?><option value="<?php echo ($v["coupon_id"]); ?>"><?php echo ($v["coupon_price"]); ?>元</option><?php endforeach; endif; ?>
                    </select>
                    ...
                    <span class="fr" style="margin-left:10px;"><input type="button" value="验证红包" class="btn_tj" /></span>
                </td>
			  </tr>
              <tr valign="top">
            ...
            <table border="0" style="width:900px; margin-top:20px;" cellspacing="0" cellpadding="0">
              ...
              <tr height="70">
                <td align="right"><a href="javascript:void(0)" class="sub"><img src="images/btn_sure.gif" /></a></td>
              </tr>
            </table>
...
<![endif]-->
<script type="text/javascript">
    jq(document).on("change",".region",function(){
        var region=jq(this).val();
        var _this=jq(this);
        jq.ajax({
            url:"/six/index.php/Home/Cart/selectRegoin",
            data:{region:region},
            success:function(data){
                ...
                if(region>0){
                    if(data.length>0){
                        var select='<select class="region">';
                        select+='<option value="0">请选择</option>';
                        jq.each(data,function(k,obj){
                            select+='<option value="'+obj.region_id+'">'+obj.region_name+'</option>';
                        })
    ...
    jq(document).on("click",".pay li",function(){
        jq(this).siblings().removeClass("checked");
        jq(this).addClass("checked");
        var pay_id=jq(this).attr("value");
        jq("input[name='pay_id']").val(pay_id);
    })

    jq(document).on("click",".sub",function(){
        jq("#form").submit();
    })
</script>
</html>