...
<div class="soubg">
	<div class="sou">
        ...
        <!--End 所在收货地区 End-->
        <span class="fr">
        	<span class="fl">你好，请<a href="<?php echo U('Index/login');?>">登录</a>&nbsp; <a href="<?php echo U('Index/login');?>" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="<?php echo U('Coupon/getCoupon');?>">领取优惠券</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
...
<div class="menu_bg">
	<div class="menu">
    	...
    	<div class="nav">
            ...
            <div class="leftNav">
                <ul>
                    <?php if(is_array($data)): foreach($data as $key=>$value): ?><li>
                    	<div class="fj">
                        	<span class="n_img"><span></span><img src="images/nav1.png" /></span>
                            <span class="fl"><a href="<?php echo U('Home/Goods/goodsList/cat_id/'.$value['cat_id']);?>"><?php echo ($value["cat_name"]); ?></a></span>
                        </div>
                        <div class="zj">
                            <div class="zj_l">
                                <div class="zj_l_c">
                                    <?php if(is_array($value['child'])): foreach($value['child'] as $key=>$val): ?><h2><a href="<?php echo U('Home/Goods/goodsList/cat_id/'.$val['cat_id']);?>"><?php echo ($val["cat_name"]); ?></a></h2>
                                        <?php if(is_array($val['child'])): foreach($val['child'] as $key=>$v): ?><a href="<?php echo U('Home/Goods/goodsList/cat_id/'.$v['cat_id']);?>"><?php echo ($v['cat_name']); ?></a>|<?php endforeach; endif; endforeach; endif; ?>
                                </div>
                                <!-- <div class="zj_l_c">
                                    <h2>零食 / 糖果 / 巧克力</h2>
                        ...
                        <ul class="featureUL" style="margin: 0px; padding: 0px; position: relative; list-style-type: none; z-index: 1; width: 3600px; left: -2400px;">
                            <li class="featureBox" style="overflow: hidden; float: left; width: 238px; height: 228px;">
                                <div class="box">
                                    ...
                                    <div class="imgbg">
                                        <a href="javascript:void(0)"><img width="160" height="136" src="images/hot1.jpg"></a>
                                    </div>                                        
                                    <div class="name">
                            ...
                            <li class="featureBox" style="overflow: hidden; float: left; width: 238px; height: 228px;">
                                <div class="box">
                                    ...
                                    <div class="imgbg">
                                        <a href="javascript:void(0)"><img width="160" height="136" src="images/hot2.jpg"></a>
                                    </div>                                        
                                    <div class="name">
                                        <a href="javascript:void(0)">
                                        <h2>iphone 6S</h2>
                            ...
                            <li class="featureBox" style="overflow: hidden; float: left; width: 238px; height: 228px;">
                                <div class="box">
                                    ...
                                    <div class="imgbg">
                                        <a href="javascript:void(0)"><img width="160" height="136" src="images/hot3.jpg"></a>
                                    </div>                                        
                                    <div class="name">
                                        <a href="javascript:void(0)">
                                        <h2>倩碧特惠组合套装</h2>
                            ...
                            <li class="featureBox" style="overflow: hidden; float: left; width: 238px; height: 228px;">
                                <div class="box">
                                    ...
                                    <div class="imgbg">
                                        <a href="javascript:void(0)"><img width="160" height="136" src="images/hot4.jpg"></a>
                                    </div>                                        
                                    <div class="name">
                                        <a href="javascript:void(0)">
                                        <h2>品利特级橄榄油</h2>
