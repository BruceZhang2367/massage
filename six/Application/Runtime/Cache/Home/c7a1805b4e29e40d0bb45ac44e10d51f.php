    ...
    <div class="content mar_20">
    	<table border="0" class="car_tab" style="width:1200px; margin-bottom:50px;" cellspacing="0" cellpadding="0">
          ...
          <?php if(is_array($cart_data)): foreach($cart_data as $key=>$v): ?><tr>
                ...
                <td align="center">
                	<div class="c_num">
                        <input type="button" name="changeNum" cart_id="<?php echo ($v["cart_id"]); ?>" onclick="jianUpdate1(jq(this));" class="car_btn_1" />
                    	<input type="text" value="<?php echo ($v["goods_number"]); ?>" class="car_ipt" />
                        <input type="button" name="changeNum" cart_id="<?php echo ($v["cart_id"]); ?>" onclick="addUpdate1(jq(this));" class="car_btn_2" />
                    </div>
                </td>
                <td align="center" style="color:#ff4e00;" class="goods_price">￥<b><?php echo ($v['goods_price']*$v['goods_number']); ?></b></td>
          ...
          <tr height="70">
          	<td colspan="6" style="font-family:'Microsoft YaHei'; border-bottom:0;">
                ...
                <span class="fr">商品总价：<b style="font-size:22px; color:#ff4e00;" class="price_sum">￥<?php echo ($goods_price); ?></b></span>
            </td>
          </tr>
          <tr valign="top" height="150">
          	<td colspan="6" align="right">
            	<a href="/six/index.php/Home/Index/index"><img src="images/buy1.gif" /></a>&nbsp; &nbsp; 
                <a href="/six/index.php/Home/Cart/buyCar_two"><img src="images/buy2.gif" /></a>
            </td>
          </tr>
        </table>
...
<![endif]-->
<script type="text/javascript">
    jq(document).on("click","input[name='changeNum']",function(){
        var num=jq(this).siblings(".car_ipt").val();
        if(num>=2){
            var cart_id=jq(this).attr("cart_id");
            var _this=jq(this);
            jq.ajax({
                url:"/six/index.php/Home/Cart/changeNum",
                data:{num:num,cart_id:cart_id},
                success:function(data){
                    console.log(data);
                    //var goods_price=data['goods_number']*data['goods_price'];
                    _this.parent().parent().next().children().html(data.small_price);
                    jq(".price_sum").html("￥"+data.goods_price);  
                    //alert(goodsprice)
                }
            })
        }else{
