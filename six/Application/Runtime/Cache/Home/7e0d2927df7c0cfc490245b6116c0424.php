...
<div class="soubg">
	<div class="sou">
        ...
        <!--End 所在收货地区 End-->
        <span class="fr">
        	<span class="fl">你好，请<a href="<?php echo U('Index/login');?>">登录</a>&nbsp; <a href="Regist.html" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
...
<div class="i_bg">
	<div class="postion">
    	<span class="fl"><?php echo ($nav_list); ?> </span>
        <span class="n_ch">
    ...
    <div class="content mar_20">
        ...
        <div class="l_list">
            ...
            <div class="list_c">
                ...
                <ul class="cate_list">
                    <?php if(is_array($cat_data)): foreach($cat_data as $key=>$v): ?><li>
                        	<div class="img">
                                <a href="<?php echo U('Home/Index/product/goods_id/'.$v['goods_id']);?>"><img src="images/per_1.jpg" width="210" height="185" /></a>
                            </div>
                            <div class="price">
                                <font>￥<span><?php echo ($v["shop_price"]); ?></span></font> &nbsp; 26R
                            </div>
                            <div class="name"><a href="<?php echo U('Home/Index/product/goods_id/'.$v['goods_id']);?>"><?php echo ($v["goods_name"]); ?></a></div>
                            <div class="carbg">
