...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="index.php?c=Back&a=admin_add" onclick="admin_add('添加管理员','admin-add.html','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
	<table class="table table-border table-bordered table-bg">
        ...
        ?>	
				...
				<td><?php if($val['admin_role']==0){echo "超级管理员";}
                        elseif ($val['admin_role']==1) {
                        	echo "总编";
                        }
                           elseif ($val['admin_role']==2) {
                        	echo "栏目总辑";
                        }
                           elseif ($val['admin_role']==3) {
                        	echo "栏目编辑";
                        }
				 ?></td>
				<td><?php echo date('Y-m-d H:s:i',$val['time'])?></td>
